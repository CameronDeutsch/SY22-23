...
﻿Public Class Form1
    ...
    Private Sub Form1_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        Select Case e.KeyCode
            ...
            Case Keys.Space
                ...
                ' AddAt(PlayBall, Player.Location, New Point(10, 5))
                AddAt(PlayBall, New Point(15, 15), "BALL")
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs)
        ' AddAt(BulletPictureBox2, New Point(40, 40), "CHASE")
        'AddAt(BulletPictureBox2, New Point(10, 5), "FOLLOW")
    End Sub
    ...
    Private Sub BottomBounceBall_Click(sender As Object, e As EventArgs)
